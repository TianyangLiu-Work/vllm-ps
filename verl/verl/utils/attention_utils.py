...
def _torch_index_first_axis(input_tensor: torch.Tensor,
                            indices: torch.Tensor) -> torch.Tensor:
    return input_tensor[indices]


def _torch_pad_input(hidden_states: torch.Tensor, indices: torch.Tensor,
...
def _torch_unpad_input(hidden_states: torch.Tensor,
    ...
    return hidden_states.flatten(0, 1)[indices], indices, cu_seqlens, max_seqlen


def _torch_rearrange(*args, **kwargs):
