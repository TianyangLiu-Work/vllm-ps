...
|---|---:|---:|---:|---:|
| baseline_single | 0.619 | 0.619 | 32 | 51.70 |
| baseline_particles | 0.612 | 0.612 | 256 | 418.07 |
| best_of_n | 1.070 | 1.070 | 256 | 239.21 |
| weighted_best_of_n | 0.603 | 0.603 | 256 | 424.62 |
| power_smc_wrapper | 0.654 | 0.654 | 32 | 48.96 |
| power_smc_internal_no_cow | 0.619 | 0.619 | 32 | 51.68 |
| power_smc_internal_cow | 0.615 | 0.615 | 32 | 52.00 |
...
|---|---|---:|---:|---:|---:|---:|
| baseline_single | yes | 10 | 49974 | 49976 | 2 | 49976 |
| baseline_particles | yes | 10 | 49976 | 49976 | 0 | 49976 |
| best_of_n | yes | 17 | 49976 | 49976 | 0 | 49976 |
| weighted_best_of_n | yes | 10 | 49976 | 49976 | 0 | 49976 |
| power_smc_wrapper | yes | 11 | 49976 | 49976 | 0 | 49976 |
| power_smc_internal_no_cow | yes | 10 | 49976 | 49976 | 0 | 49976 |
| power_smc_internal_cow | yes | 10 | 49976 | 49976 | 0 | 49976 |
...
| Run | Diagnostics | Missing | Mean final ESS | Total resamples | Max resamples | Mean unique ancestors | KV aliases | KV fallbacks | KV aliased blocks | KV aliased tokens | Mean done | Max done | Particle len range | Finish reasons | Resample skips | Chosen particles |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---|---|
| power_smc_wrapper | 1/1 | 0 | 1.004 | 1 | 1 | 2.000 | 0 | 0 | 0 | 0 | - | 0 | 0-0 | {} | {} | {"3": 1} |
| power_smc_internal_no_cow | 1/1 | 0 | 1.300 | 1 | 1 | 7.000 | 0 | 8 | 0 | 0 | 8.000 | 8 | 32-32 | {"length": 8} | {"not_block_boundary": 15, "stale_block_boundary": 15} | {"6": 1} |
| power_smc_internal_cow | 1/1 | 0 | 1.401 | 1 | 1 | 7.000 | 8 | 0 | 16 | 256 | 8.000 | 8 | 32-32 | {"length": 8} | {"not_block_boundary": 15, "stale_block_boundary": 15} | {"6": 1} |
