...
class SamplingMetadata:
    ...
    # Per-request alpha_t for Power-SMC power-temperature proposal. When set,
    # the sampler returns sampled-token base/proposal logprobs needed for
    # importance-weight updates.
    power_smc_alpha: torch.Tensor | None = None
