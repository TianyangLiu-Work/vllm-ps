...
class AsyncGPUModelRunnerOutput(AsyncModelRunnerOutput):
    def __init__(
        ...
        power_smc_logprobs: PowerSMCLogprobTensors | None,
        ...
        self._power_smc_logprobs = power_smc_logprobs
        ...
        with torch.cuda.stream(async_output_copy_stream):
            ...
            self._power_smc_logprobs_cpu = (
                self._power_smc_logprobs.to_cpu_nonblocking()
                if self._power_smc_logprobs
                else None
            )
    ...
    def get_output(self) -> ModelRunnerOutput:
        ...
        if self._power_smc_logprobs_cpu is not None:
            output.power_smc_logprobs = self._power_smc_logprobs_cpu.tolists()
...
class GPUModelRunner(
    ...
    def _sample(
        ...
        self.input_batch.update_power_smc_sampling_state()
    ...
    def sample_tokens(
        ...
        with record_function_or_nullcontext(
            ...
            async_output = AsyncGPUModelRunnerOutput(
                ...
                sampled_token_ids=sampler_output.sampled_token_ids,
                logprobs_tensors=sampler_output.logprobs_tensors,
                power_smc_logprobs=sampler_output.power_smc_logprobs,
