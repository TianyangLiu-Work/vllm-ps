...
class RequestOutput:
    ...
    Args:
        ...
        power_smc: Optional Power-SMC diagnostics.
    """
    ...
    def __init__(
        ...
        *,
        ...
        power_smc: dict[str, Any] | None = None,
    ...
    def add(self, next_output: "RequestOutput", aggregate: bool) -> None:
        ...
        self.power_smc = next_output.power_smc or self.power_smc
